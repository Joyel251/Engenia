    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">Photo Gallery Management</h1>
          <p className="text-gray-400">Import images from Google Drive folder</p>
        </div>

        {/* Setup Instructions */}
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-6 mb-8">
          <h2 className="text-xl font-bold mb-3 text-blue-300">📋 Setup Instructions</h2>
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-300">
            ...
            <li>Add the API key to your <code className="bg-gray-700 px-2 py-1 rounded">.env.local</code> file as:
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
          <form onSubmit={handleImport} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-6 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2"
            >
              {loading ? (
                <>
        ...
        <div className="mt-8 p-6 bg-gray-800/30 rounded-lg border border-gray-700">
          <h3 className="text-lg font-bold mb-3">ℹ️ Important Notes</h3>
