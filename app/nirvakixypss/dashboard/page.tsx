        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 space-y-3 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              {/* System Reset + Photo Gallery + Logout Buttons */}
              <button
              ...
              <Link
                href="/nirvakixypss/photogallery"
                className="flex items-center justify-center space-x-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-medium border-2 border-purple-500/50 w-full sm:w-auto"
              >
